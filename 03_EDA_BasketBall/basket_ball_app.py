...
st.sidebar.header("user input features".capitalize())
selected_year = st.sidebar.selectbox("Year", list(reversed(range(1950, now.year + 1))))
...
#     # df_selected_team.to_csv('output.csv',index=True)
